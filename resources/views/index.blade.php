...
<head>
	...
	<link rel="stylesheet" href="{{url('public')}}/../fontawesome/css/all.min.css"> <!-- https://fontawesome.com/ -->
	<link href="https://fonts.googleapis.com/css2?family=Source+Sans+Pro&display=swap" rel="stylesheet"> <!-- https://fonts.google.com/ -->
    <link href="{{url('public')}}/../css/bootstrap.min.css" rel="stylesheet">
    <link href="{{url('public')}}/../css/templatemo-xtra-blog.css" rel="stylesheet">
<!--
...
<body>
        ...
        <div class="tm-header-wrapper">
            ...
            <nav class="tm-nav" id="tm-nav">            
                <ul>
                    ...
                    <li class="tm-nav-item"><a href="{{url('contacts')}}" class="tm-nav-link">
            ...
            <div class="row tm-row">
                <article class="col-12 col-md-6 tm-post">
                    ...
                    <a href="post.html" class="effect-lily tm-post-link tm-pt-60">
                        ...
                        <h2 class="tm-pt-30 tm-color-primary tm-post-title">Mengeluh Kepada Raffi Ahmad, Dimas Ramadhan: Jadi Artis Tuh Ternyata Capek Banget   </h2>
                    </a>                    
                    <p class="tm-pt-30">
                ...
                <article class="col-12 col-md-6 tm-post">
                    ...
                    <a href="post.html" class="effect-lily tm-post-link tm-pt-60">
                        ...
                        <span class="position-absolute tm-new-badge">New</span>
                        <h2 class="tm-pt-30 tm-color-primary tm-post-title">SISTEM INFORMASI GEOGRAFIS PERUMAHAN DAN FASILITAS SOSIAL TERDEKAT DI KABUPATEN KETAPANG</h2>
                    </a>                    
                    <p class="tm-pt-30">
                        <a rel="nofollow" href="https://templatemo.com/tm-553-xtra-blog" target="_blank"></a>  Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
                    </p>
                    <div class="d-flex justify-content-between tm-pt-45">
    ...
    <script src="{{url('public')}}/../js/templatemo-script.js"></script>
</body>
</html>